...
async def on_message(message):
    ...
    if message.content.startswith('!fortnite'):
        randomlist = ['https://filemedia.net/27527/# Work with Python xxx
import discord
from discord.ext import commands, tasks
import os
import asyncio
...
async def on_message(message):
    ...
    if message.content.startswith('!origin'):
        randomlist = ['https://link-to.net/27527/origin','https://up-to-down.net/27527/origin','http://direct-link.net/27527/origin']
        msg = 'Hello ' + author + '. Your link: '
        await message.channel.send(msg + (random.choice(randomlist)))
...
client.run(os.getenv('BOT_TOKEN'))','https://up-to-down.net/27527/fortnite02','https://up-to-down.net/27527/fortnite02']
        msg = 'Hello ' + author + '. Your link: '
        await message.channel.send(msg + (random.choice(randomlist)))
